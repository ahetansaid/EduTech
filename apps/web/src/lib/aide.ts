...
export const PROFILS: ContenuProfil[] = [
  ...
  },
  {
    ...
    ecrans: [
      ...
      { titre: "Parcours pro", chemin: "/enseignant/carriere", icone: "graduation", resume: "Votre passeport professionnel.", points: ["Grade, ancienneté, charge, formations validées.", "Catalogue de formation continue : « S'inscrire »."] },
    ],
    taches: [
