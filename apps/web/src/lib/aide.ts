...
export const PROFILS: ContenuProfil[] = [
  ...
  },
  {
    ...
    taches: [
      ...
      { titre: "Lire les statistiques de la promotion", pourquoi: "Une moyenne classe ne dit rien de la dispersion : deux classes à 11/20 n'ont pas le même décrochage.", etapes: ["Sous la liste des apprenants, dépliez « Statistiques de la promotion ».", "Comparez moyenne, médiane et écart-type : un écart-type élevé signale une promotion hétérogène.", "Regardez les bandes de moyennes et d'absences plutôt qu'un seul pourcentage.", "Lisez la ligne « Filles et garçons » pour repérer un écart à creuser.", "Recoupez avec le panneau « Vigilance décrochage » avant de décider un accompagnement.", "Touchez « Exporter (CSV) » en bas du panneau pour conserver ce portrait (moyennes, bandes, comparatif, vigilance) : les mêmes chiffres que l'écran, dans un fichier daté portant sa provenance."] },
