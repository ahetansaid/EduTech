...
**Pour qui :** Chercheurs et analystes habilités (universités, instituts, partenaires).  
**Votre espace :** Ask Education — vous y arrivez directement après la connexion (`/ask`).  
**Accès :** https://edu-tech-api-rho.vercel.app/ask · centre d'aide en ligne : https://edu-tech-api-rho.vercel.app/aide/chercheur

> Obtenir des chiffres fiables et citables sur le système éducatif, sans jamais accéder à une donnée personnelle.
...
`/ask` — Une question en français, un chiffre prouvé.

- Chiffre, définition, source, couverture et indice de confiance.
- Petits effectifs masqués ; questions sur une personne refusées et journalisées.
...
### Obtenir un chiffre citable

1. Posez votre question dans Ask Education, ou touchez un exemple.
2. Notez le chiffre, l'indicateur utilisé, la source et l'indice de confiance.
3. Ouvrez le Dictionnaire national et relevez la définition et sa version.
4. Citez les trois : chiffre, définition (avec version), date de consultation.

### Comprendre un refus

1. Lisez le motif affiché sous la question (donnée personnelle, hors périmètre, effectif trop petit…).
2. Reformulez en agrégat (par département, par année) plutôt que par personne ou par petit groupe.
...
- Citez toujours la version de la définition utilisée.
- Ne tentez pas de recouper des résultats pour identifier une personne : c'est interdit et journalisé.
