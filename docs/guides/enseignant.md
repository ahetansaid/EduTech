...
**Pour qui :** Enseignantes et enseignants, en ville comme en brousse.  
**Votre espace :** Espace enseignant — vous y arrivez directement après la connexion (`/enseignant`).  
**Accès :** https://edu-tech-api-rho.vercel.app/enseignant · centre d'aide en ligne : https://edu-tech-api-rho.vercel.app/aide/enseignant

> Faire l'appel en deux minutes et saisir les notes depuis votre téléphone. Ce que vous saisissez prévient les familles et alimente les bulletins, sans rien recopier.
...
`/enseignant` — Une carte par classe.

- Présence du jour (anneau), moyenne du trimestre, remplissage.
- Deux gros boutons : « Appel » et « Notes ».

### Carnet de classe

`/enseignant/classe/…` — Quatre sections : Appel, Notes, Historique, Élèves.

- Appel : un toucher = absent, un second annule, puis « Valider ».
- Notes : saisie sur 20 au quart de point ; correction avec motif obligatoire.
- Historique : appels, notes et corrections de la classe.
- Élèves : fiches, moyennes et absences, tri par moyenne ou absences.

### Parcours pro

`/enseignant/carriere` — Votre passeport professionnel.
...
> Chaque absence validée prévient la famille et informe la direction, sans cahier à recopier.

1. Sur la carte de la classe, touchez « Appel ».
2. Touchez chaque élève absent : sa ligne passe au rouge. Touchez à nouveau pour annuler.
3. Vérifiez le compteur présents / absents.
4. Touchez « Valider · N absents ». Le message « Appel enregistré » confirme l'envoi.

### Faire l'appel sans réseau

> L'école n'a pas toujours de réseau : rien ne doit se perdre.

1. Faites l'appel normalement. Le bouton devient orange et indique « (hors ligne) ».
2. Touchez-le : « Appel conservé » s'affiche. L'appel est gardé sur le téléphone.
3. Au retour du réseau, l'envoi est automatique. Le bandeau « saisies en attente » disparaît.
4. Pour forcer l'envoi, touchez « Envoyer » dans le bandeau. Ne videz pas les données du navigateur avant l'envoi.

### Saisir les notes d'une évaluation

1. Sur la carte de la classe, touchez « Notes ».
2. Choisissez la matière (si vous en avez plusieurs) et le trimestre (T1, T2, T3).
3. Tapez chaque note sur 20 (au quart de point : 12,25). « Entrée » passe à l'élève suivant.
4. Touchez « Enregistrer N notes ». Une note invalide est signalée en rouge avant l'envoi.

### Corriger une note

> La note d'origine n'est jamais effacée : la correction est ajoutée, datée, signée, et la famille est informée.

1. Dans « Évaluations enregistrées », touchez la note à corriger.
...
**J'ai marqué un élève absent par erreur, avant de valider.**  
Touchez-le à nouveau : il redevient présent. « Tout présent » annule toute la saisie en cours.

**J'ai validé une absence par erreur.**  
Une absence enregistrée est verrouillée. Prévenez la direction de l'établissement, qui peut la traiter.

**Mes saisies hors connexion sont-elles perdues si je ferme l'application ?**  
Non, elles restent sur le téléphone. Elles sont perdues seulement si vous effacez les données du navigateur avant l'envoi.

**Je suis aussi parent d'élève.**  
L'onglet « Mon enfant » ouvre l'espace famille avec le même compte.
...
- Faites l'appel en début de cours : les familles sont prévenues le jour même.
- Gardez un code de verrouillage sur votre téléphone.
- Vérifiez de temps en temps le bandeau « saisies en attente » quand vous travaillez sans réseau.
