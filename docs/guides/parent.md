...
**Pour qui :** Parents et tuteurs légaux.  
**Votre espace :** Espace famille — vous y arrivez directement après la connexion (`/famille`).  
**Accès :** https://edu-tech-api-rho.vercel.app/famille · centre d'aide en ligne : https://edu-tech-api-rho.vercel.app/aide/parent

> Savoir le jour même si votre enfant est absent, suivre ses résultats, justifier une absence en un geste et retrouver ses diplômes.
...
`/famille` — La fiche de chaque enfant.

- Identité, classe, établissement.
- Moyenne, évolution, absences, évaluations.
- Absences à justifier, résultats par matière, dernières notes, parcours.

### Notifications

`/famille/notifications` — Les messages nés des faits enregistrés par l'école.

- Absence, nouvelle note, note corrigée…
- Filtre « Toutes » / « Non lues », « Tout marquer comme lu ».

### Documents

`/famille/documents` — Les diplômes de vos enfants.

- Chaque diplôme porte un QR code vérifiable sans compte.

## Tâches pas à pas

### Justifier une absence

> L'établissement reçoit le motif aussitôt, sans billet papier.

1. Dans « Absences », repérez le jour marqué « À justifier ».
2. Touchez « Justifier ».
3. Choisissez le motif : Maladie, Rendez-vous médical, Raison familiale, Transport ou Autre.
4. Ajoutez une précision si besoin (obligatoire pour « Autre »), puis touchez « Transmettre ».
...
1. Ouvrez « Documents ».
2. Montrez le QR code du diplôme : la personne le scanne et vérifie elle-même, sans compte.

## Questions fréquentes

**Je ne vois pas mon enfant.**  
Le lien parent-enfant vient du registre national. Rapprochez-vous de l'établissement de votre enfant pour vérifier l'inscription.

**J'ai plusieurs enfants.**  
Un sélecteur avec leurs prénoms apparaît en haut de l'écran « Mes enfants ».

**L'absence reste « Transmise ».**  
L'établissement doit valider votre justificatif. Elle passera ensuite à « Justifiée ».
...
- Ne prêtez pas votre compte à votre enfant : il a le sien s'il est apprenant.
- Activez le verrouillage de votre téléphone.
