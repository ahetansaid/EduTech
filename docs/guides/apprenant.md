...
**Pour qui :** Élèves et apprenants.  
**Votre espace :** Mon passeport éducatif — vous y arrivez directement après la connexion (`/apprenant`).  
**Accès :** https://edu-tech-api-rho.vercel.app/apprenant · centre d'aide en ligne : https://edu-tech-api-rho.vercel.app/aide/apprenant

> Retrouver tout votre parcours scolaire, quelle que soit l'école, et prouver vos diplômes à une école ou un employeur sans démarche.
...
`/apprenant` — Votre passeport éducatif.
...
`/apprenant/preuves` — Vos preuves, à partager.
...
> La personne vérifie elle-même l'authenticité, en quelques secondes, sans compte.

1. Ouvrez « Mes diplômes ».
2. Touchez « Copier le lien » et collez-le dans un message, ou « Partager » sur téléphone.
3. En face à face, touchez « QR en grand » et laissez scanner le code.
...
- Ne partagez que le lien ou le QR code de vérification, jamais votre mot de passe.
- Déconnectez-vous sur un ordinateur de l'école.
